...
<head>
    ...
    <title>Recuperar Contraseña - Préstamos FIM</title>
...
<body class="bg-gradient-to-br from-indigo-900 via-gray-800 to-black min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white p-8 rounded-2xl shadow-2xl w-full max-w-md border-t-4 border-indigo-600 relative overflow-hidden">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-sm text-gray-500 mt-1">Ingresa tu correo para recibir el enlace de restablecimiento</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="tucorreo@ejemplo.com" class="w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all" required autofocus>
                </div>
            </div>
