...
<head>
    ...
    <style>
        ...
        .dark .divide-gray-100 > * { border-color: #1a3356 !important; }
        ...
        .dark select, .dark input[type="text"], .dark input[type="date"], .dark input[type="number"], .dark input[type="time"], .dark textarea { background-color: #0d1f3c !important; border-color: #1a3356 !important; color: #c8d6e5 !important; }
